...
echo 'Downloading and processing abundance data.'
Rscript download_and_process_abundance_data.R cmd_metadata_example_CRC.rds t_metaphlan_abundance_cmd_example_CRC.rds metaphlan_mapping_data_example_CRC
...
Rscript prune_metadata.R cmd_metadata_example_CRC.rds CRC 0.9 CRC_example_modeldfs.rds
...
Rscript compute_associations.R CRC_example_modeldfs.rds t_metaphlan_abundance_cmd_example_CRC.rds CRC_example_associations.rds CRC
...
#args: clean meta analysis output, name of output file that will contain features to vibrate over
...
Rscript compute_vibrations.R CRC_example_modeldfs.rds example_CRC_features_to_vibrate.rds t_metaphlan_abundance_cmd_example_CRC.rds example_CRC_vibration_output.rds CRC  
